...
@section('title', ($products->first()->category->name ?? 'Category') . ' Products - Nexwear')
...
<div class="container py-5 mt-5">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ $products->first()->category->name ?? 'Category' }}</li>
        </ol>
    </nav>
            ...
            <div class="card border-0 shadow-sm bg-light">
                <div class="card-body py-5">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h1 class="display-5 mb-3">{{ $products->first()->category->name ?? 'Category' }}</h1>
                            <p class="lead text-muted">
                                {{ $products->first()->category->description ?? 'Browse our collection of products in this category.' }}
                            </p>
                        </div>
                        <div class="col-md-4 text-center">
                            @if($products->first()->category->thumbnail ?? false)
                                <img src="{{ asset('storage/images/' . $products->first()->category->thumbnail) }}"
                                     alt="{{ $products->first()->category->name }}"
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <form action="{{ route('customer.products.by_category', $categoryId) }}" method="GET" id="filterForm">
